...
// New icon for opening sidebar (replaces IconMenu)
export const IconOpenSidebar: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
...
// New icon for closing sidebar
export const IconLayoutSidebar: React.FC<{ className?: string }> = ({ className = "w-5 h-5" }) => (
...
export const IconPencil: React.FC<{ className?: string }> = ({ className = "w-4 h-4" }) => ( // Default size w-4 h-4 to match others
  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className={className} viewBox="0 0 16 16" aria-hidden="true">
...
export const IconThumbDown: React.FC<{ className?: string; style?: React.CSSProperties }> = ({ className = "w-4 h-4", style }) => (
  <svg 
    xmlns="http://www.w3.org/2000/svg" 
    width="16" 
    height="16" 
    ...
    className={className} 
    viewBox="0 0 16 16" 
    style={{ ...style, transform: (style?.transform || '') + ' scaleX(-1)' }} // Append to existing transform if any
    aria-hidden="true"
  >
...
export const IconThumbDownSolid: React.FC<{ className?: string; style?: React.CSSProperties }> = ({ className = "w-4 h-4", style }) => (
  <svg 
    xmlns="http://www.w3.org/2000/svg" 
    width="16" 
    height="16" 
...
// Retry Icon / Reload Prompt Icon
export const IconArrowRepeat: React.FC<{ className?: string }> = ({ className = "w-4 h-4" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className={className} viewBox="0 0 16 16" aria-hidden="true">
...
export const IconLogout: React.FC<{ className?: string }> = ({ className = "w-5 h-5" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
