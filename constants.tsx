...
export const IconClipboardDocumentList: React.FC<{ className?: string }> = ({ className = "w-4 h-4" }) => (
  <svg
    ...
    fill="none"
    viewBox="0 0 24 24"
    strokeWidth="2.5" // Thicker stroke to match user-provided image style
    stroke="currentColor"
    className={className}
    aria-hidden="true"
  >
    {/* Background square (top-right, drawn first to be behind) */}
    <rect x="9" y="5" width="10" height="10" rx="3" />
    {/* Foreground square (bottom-left) */}
    <rect x="5" y="9" width="10" height="10" rx="3" />
  </svg>
);
